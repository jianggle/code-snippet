...
(function() {
    ...
    B.ka = bmapCfg.home;  // TODO 修改，本地工具资源引用(离线路径)
    ...
    md.getTilesUrl = function(a, b, c) {
      var e = a.x, a = a.y, f = Sb("normal"), g = 1, c = ld[c];
      if (bmapCfg.enableOffline) {
        let key = b + "-" + e + "-" + a;
        return bmapCfg.tiles_server + key + bmapCfg.imgext; // 使用本地的瓦片
      }
      this.map.Sx() && (g = 2);  //修改
